...
@router.get("/clients")
def get_payments_clients(db: Session = Depends(get_db)):
    return payment_crud.get_payments_clients(db)

@router.post("/", response_model=payment_schema.PaymentOut, status_code=201)
